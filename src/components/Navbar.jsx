              ...
              {isLoggedIn ? (
                ...
                <>
                  ...
                  <button onClick={() => handleNavigation("profile")}
                    className={`block w-full text-left px-3 py-2 rounded-md text-hotel-cream ${hoverStyle}`}>
                    My Profile
                  </button>
          ...
          <div className="px-4 py-3 space-y-2">
            ...
            {isLoggedIn ? (
              <>
                ...
                <button onClick={() => handleNavigation("profile")} className={`block w-full text-left px-3 py-2 rounded-md text-hotel-cream ${hoverStyle}`}>
                  My Profile
                </button>
              </>
            ) : (
