                ...
                <div className="flex-wrap w-full items-center justify-center gap-8 mb-8 max-w-7xl mx-auto">
                    <form className="bg-hotel-dark/80 backdrop-blur-md p-8 rounded-lg shadow-lg">
                        <div className="flex flex-wrap gap-20 mb-4">
                            ...
                            <div className="flex-1 w-full mb-6 text-1xl font-serif text-hotel-gold tracking-wider">
                                <p>GUESTS</p>
                                <input value={guests} onChange={e => setGuests(Number(e.target.value))} type="number" min="0" className="w-full p-2 rounded-md bg-hotel-dark/50 text-hotel-cream focus:outline-none focus:ring-2 focus:ring-hotel-gold" />
                            </div>
                            <button type="submit" className="flex-1 mb-6 mt-4 py-2 bg-hotel-gold text-hotel-dark rounded-md hover:bg-hotel-gold/90 transition-colors" onClick={handleBooking}>
                                Booking &nbsp; &nbsp; &gt;
                            </button>
                        </div>
                ...
                {selectedAccomodation !== null ? (
                    <div className="flex mt-8 bg-white/5 backdrop-blur-md p-8 rounded-lg shadow-lg max-w-6xl h-8xl mx-auto">
                        <div className="items-center justify-center mb-6">
                            ...
                            <button className="mt-20 mr-4 px-6 py-2 bg-hotel-gold text-hotel-dark rounded-md hover:bg-hotel-gold/90 transition-colors" onClick={() => navigate('/double-room', { state: { room: { name: accomodationDesc[selectedCategory][selectedAccomodation][0] } } })}>
                                Book Now
                            </button>
                        </div>
